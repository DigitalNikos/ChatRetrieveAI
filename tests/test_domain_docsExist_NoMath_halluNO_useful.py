...
class TestPath1ChatPdf(unittest.TestCase):
    def setUp(self):
        print(cfg)
    ...
    def test_path_1(self):
        question = "How is AI applied in basketball player performance evaluation?"
        ...
        # Check if the final answer is not "I don't know the answer"
        self.assertNotEqual(state['answer']['answer'], "I don't know the answer to that question.")
